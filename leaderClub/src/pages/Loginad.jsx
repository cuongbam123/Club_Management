    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2
                    className={`text-2xl font-bold text-center mb-6 transition-all duration-500 ${toggleOn ? "text-cyan-400 drop-shadow-[0_0_10px_#22d3ee]" : "text-white"
                        }`}
                >
                    Login Admin/Leader
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    {inputs.map((input, idx) => (
                        <div key={idx} className="relative">
                            ...
                            />
                            <span
                                className={`absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 transition-all ${toggleOn ? "text-cyan-400" : "text-gray-400"
                                    }`}
                            >
                                {input.icon}
                            </span>
