                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative">
                        <input
                            ...
                            required
                            placeholder="Email"
                            className={`w-full bg-transparent border-b-2 px-2 pt-4 pb-2 focus:outline-none placeholder-gray-400 transition-all
                            ${toggleOn
                                    ? "border-cyan-400 text-cyan-300 placeholder-cyan-400 focus:border-cyan-300"
                                    : "border-gray-500 text-white focus:border-white"}`}
                        />
                        <IoMail
