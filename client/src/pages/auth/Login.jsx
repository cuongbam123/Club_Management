...
export default function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            if (
                ...
                // ✅ Sau 1.5s điều hướng sang trang chủ
                setTimeout(() => {
                    navigate("/");
                }, 1500);
            } else {
    ...
    return (
        ...
        >
            <ToastContainer />
            <div
                className={`relative w-[400px] p-8 rounded-2xl shadow-lg transition-all duration-500 ${toggleOn
                    ? "bg-cyan-950/70 shadow-cyan-400/60"
                    : "bg-neutral-900"
                    }`}
            >
                {/* Toggle switch */}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Remember + Forgot */}
                    <div
                        className={`flex justify-between text-sm transition-all ${toggleOn ? "text-cyan-400" : "text-gray-300"
                            }`}
                    >
                    ...
                    {/* Register */}
                    <p
                        className={`text-center text-sm transition-all ${toggleOn ? "text-cyan-400" : "text-gray-300"
                            }`}
                    >
